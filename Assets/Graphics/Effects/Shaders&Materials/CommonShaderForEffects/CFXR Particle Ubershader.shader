...
//		_ReceivedShadowsStrength ("Received Shadows Strength", Range(0,1)) = 0.5
	...
	Category
	{
		...
		#if PASS_SHADOW_CASTER
			void vertex_program (MeshData v, out v2f_shadowCaster o, out float4 opos : SV_POSITION)
		#else
			Interpolators vertex_program (MeshData v)
		#endif
			{
		#if !PASS_SHADOW_CASTER
		...
		#else
			half4 fragment_program (Interpolators i) : SV_Target
		#endif
			{
